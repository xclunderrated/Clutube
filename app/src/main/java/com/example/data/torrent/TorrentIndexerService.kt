...
object TorrentIndexerService {
    ...
    /** Bounded: a miss only costs one extra external_ids lookup. */
    private val imdbCache = object : java.util.concurrent.ConcurrentHashMap<String, String>() {
    ...
    /** Single-sourced from TmdbClient (BuildConfig TMDB_API_KEY with fallback). */
    private val TMDB_API_KEY: String get() = com.example.data.tmdb.TmdbClient.API_KEY

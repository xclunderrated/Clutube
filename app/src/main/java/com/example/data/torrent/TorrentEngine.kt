...
object TorrentEngine {
    ...
    /**
     * Removes the session handle. Partials are kept by default so a later
     * retry rechecks hashes and resumes; pass deleteFiles only when the
     * payload was already moved out (post-completion staging cleanup).
     */
    fun cancel(downloadId: String, deleteFiles: Boolean = false) {

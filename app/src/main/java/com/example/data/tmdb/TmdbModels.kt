...
data class TmdbImagesResponse(
    @Json(name = "id") val id: Int? = null,
    @Json(name = "backdrops") val backdrops: List<TmdbImageItem> = emptyList(),
    @Json(name = "posters") val posters: List<TmdbImageItem> = emptyList(),
    @Json(name = "logos") val logos: List<TmdbImageItem> = emptyList()
)

...
interface TmdbApiService {
    ...
    /**
     * Lightweight details without credits/images, for visible-card studio
     * attribution on infinite-scroll feeds.
     */
    @GET("movie/{movie_id}")
    ...
    /** Lightweight TV details without credits/images — see [getMovieBasic]. */
    @GET("tv/{tv_id}")

 ...
 * not resolved yet. The feed shows a shimmer placeholder instead of this
 * string until visible-card enrichment replaces it with the real studio.
 */
...
data class VideoItem(
    ...
    val hasTitledBackdrop: Boolean = false,

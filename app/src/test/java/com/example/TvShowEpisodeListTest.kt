...
class TvShowEpisodeListTest {
    ...
    fun `meta shows formatted date and rating, title uses non-bold style`() {
        ...
        // substring=true: the row merges date/runtime/rating into one node.
        composeTestRule.onNodeWithTag("episode_item_1_1")
            .assertIsDisplayed()
            .assertTextContains("Jan 1, 2020", substring = true)
            .assertTextContains("45 min", substring = true)
            .assertTextContains("★ 7/10", substring = true)
    }
